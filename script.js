...
const MAPAS_CONFIG = {
    "2": [
        ...
        { nombre: "Railway" },
        { nombre: "Riverbed" },
        { nombre: "Sands of Time", descripcion: "Map size: 257 | Strat. points: 7 | Relics: 2 | Critical loc.: 3" },
    ...
    "3": [
        ...
        { nombre: "Inquisitors Fortress", descripcion: "Map size: 513<br/>Strat. points: 11 | Critical loc.: 2 | Relics: 2 | Slag depos: 2<br/>You'll get some help here from the Blood Angels." },
    ],
    "4": [
        { nombre: "Antiga Bay", iconoNombre: "Antiga Bay (4)" },
        { nombre: "Apocalypse Later", descripcion: "Map size: 513<br/>Strat. points: 16 | Critical loc.: 1 | Relics: 2 | Slag depos: 2" },
